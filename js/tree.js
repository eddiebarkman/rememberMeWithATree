...
<?php while ($row = mysql_fetch_array($query)) {
    ...
    ?>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="col-span-10 col-style autoheight">
                                            ...
                                            <p>A tree to remember <?php echo $row['First']; ?> <?php echo $row['Last']; ?>.</p>
            ...
            <p>A tree planted just for
                <?php echo $row['First']; ?>
                    <?php echo $row['Last']; ?>.</p>
            <p>With us from
                <?php echo date('F j, Y',strtotime($row['Birth'])); ?> to
                    <?php echo date('F j, Y',strtotime($row['Death'])); ?>
            </p>

            <p>Your tree is
                <?php echo $treeAge; ?> day(s) old.</p>
